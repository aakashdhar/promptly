...
const INPUT_STYLE = {
  background: 'rgba(var(--ink),0.03)', border: '0.5px solid rgba(var(--ink),0.08)',
  borderRadius: '7px', padding: '7px 10px', fontSize: '11px',
  color: 'rgba(var(--ink),0.86)', fontStyle: 'italic', outline: 'none',
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '20px 28px', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        borderTop: '1px solid rgba(var(--ink),0.06)', marginTop: '10px',
      }}>
        <button
          onClick={onReiterate}
